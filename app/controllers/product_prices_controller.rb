class ProductPricesController < ApplicationController
  ...
  def index
    ...
    respond_to do |format|
      format.html
      format.csv { send_data @product_prices.to_csv, filename: "product-#{Date.today}.csv" }
    end
  ...
  def CSV
    @product_prices = ProductPrice.all
    send_data @product_prices.to_csv, filename: "product-#{Date.today}.csv"
  end
  ...
  private
    ...
    def product_price_params
      params.require(:product_price).permit(:name)
    end
end
